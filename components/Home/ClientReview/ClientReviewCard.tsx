...
const ClientReviewCard = ({ name, image, role }: Props) => {
  return (
    ...
    <p className='mt-6 text-base text-gray-200 font-medium'>
       ...
       id modi repellendus cupiditate deserunt omnis aperiam ducimus, 
       fugit dolorem corrupti exercitationem delectus, 
       unde provident repudiandae accusamus officiis. 
       In, omnis dicta. &quot;
    </p>

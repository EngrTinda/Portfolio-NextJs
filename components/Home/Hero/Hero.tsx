...
<ParticlesHero />
        <div className='relative z-10 flex flex-col items-center'>
            ...
            data-aos="fade-up"
            />
            <h1 data-aos="fade-up" data-aos-delay="200" className='text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mt-6 tracking-wide'> 
            ...
            <h2 data-aos="fade-up" data-aos-delay="400" className='mt-5 text-sm px-2 text-center sm:text-2xl font-medium flex items-center'>
                Hi! I&apos;m Tinda - A Passionate 
                <span className='text-cyan-200 font-bold'>
                    <Typewriter
                        options={{
                            strings: ['Full-Stack Developer', 'Cloud Engineer', 'Machine Learning Engineer'],
                            autoStart: true,
                            loop: true,
                            delay: 75,
                            deleteSpeed: 50,
